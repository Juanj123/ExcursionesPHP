...
class DaoPagos
{
			...
			public function obtenerUsuarios($id)
	{
		try
		{
			...
			$sentenciaSQL = $this->conexion->prepare("select nombres, apellidos, correo, direccion from usuarios where idUsuario= $id"); /*Se arma la sentencia sql para seleccionar todos los registros de la base de datos*/

...
<body>
            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        <label id="lblNinosMay" style="position: absolute; margin-left: 130px; margin-top: -165px; display: none">Total a pagar</label>
                        <h1 id="lblTotalNinosMay" style="position: absolute; margin-left: 250px; margin-top: -180px; display: none;"></h1>
                    </li>
                    <li class="list-group-item">
    ...
    <div class="col-md-2" style="position: static; margin-top: -460px; margin-left: 50px">
